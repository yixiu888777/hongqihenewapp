			...
			<view class="content">
				<view class="form">
					...
					<view class="item">
						...
						<view class="item-input flex_between">
							<input type="text" v-model="form.bank_name" class="input" placeholder="请输入银行名称(例:建设银行)"
								placeholder-class="placeholder" maxlength="19" />
						</view>
					</view>
					<view class="item">
					...
					<view class="item">
						...
						<view class="item-input flex_between">
							<input type="number" v-model="form.card_no" class="input" placeholder="请输入卡号"
								placeholder-class="placeholder" />
						</view>
					</view>
