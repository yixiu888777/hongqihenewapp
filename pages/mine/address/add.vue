		...
		<view class="main">
			<view class="content">
				<view class="form">
					<view class="item">
						...
						<view class="item-input flex_between">
							<input type="text" class="input" v-model="form.name" placeholder="请输入收件人"
								:disabled="disabled" placeholder-class="placeholder" @blur="containsChinese" />
						</view>
					</view>
					<view class="item">
						<view class="item-name">
						...
						<view class="item-input flex_between">
							<input type="number" v-model="form.phone" class="input" placeholder="请输入手机号"
								:disabled="disabled" placeholder-class="placeholder" maxlength="11" />
						</view>
					</view>
					...
					<view class="item">
						...
						<view class="item-input flex_between">
							<input type="text" v-model="form.address" class="input" placeholder="小区、写字楼、门牌号等"
								:disabled="disabled" placeholder-class="placeholder" />
						</view>
					</view>
				</view>
				...
				<view class="fixedBtn" v-if="total > 0">
					<view class="btn" @click="toLoads(settingInfo.service_url)">
						<view class="icon">
			...
			<view class="footer flex_center">
				<view class="button del" @click="delClick" v-if="id">删除</view>
...
<script>
	...
	export default {
		...
		onLoad(opt) {
			...
			// userAddressListApi({ page: 1 }).then(res => {
				...
				.item {
					...
					.choose {
						...
						.box {
							...
							flex-shrink: 0;
							margin-right: 20rpx;
							background: linear-gradient(to left, #ddd, #aaa);
						}
