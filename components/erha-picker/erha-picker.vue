<template>
	<u-popup :show="true" mode="bottom" @close="closeClick">
	    <view class="level-container">
	    	...
	    	<ul class="name-list">
	    		...
	    		<li :class="showIndex==3?'select':''" @click="anewSelect(3)" v-if="showIndex>=3 && maxLevel >= 4">{{street}}</li>
	    	</ul>
	    	...
	    	<ul v-if="showIndex==3 && maxLevel >= 4" class="content" :style="'height:'+ heightCot + 'upx'">
